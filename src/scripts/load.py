...
class Load:
    def __init__(self, host=None):
        ...
        self.utils = Utils()
        self.conn_string_default_DB = self.settings.POSTGRES_CONNECTION_STRING_DEFAULT_DB if host is None else self.settings.POSTGRES_CONNECTION_STRING_DOCKER_DEFAULT_DB
        self.conn_string_for_cursor_default_DB = self.settings.POSTGRES_CURSOR_CONNECTION_STRING_DEFAULT_DB if host is None else self.settings.POSTGRES_CURSOR_CONNECTION_STRING_DOCKER_DEFAULT_DB
        self.engine = None
        self.conn_string_new_DB = self.settings.POSTGRES_CONNECTION_STRING_NEW_DB if host is None else self.settings.POSTGRES_CONNECTION_STRING_DOCKER_NEW_DB
        self.conn_string_for_cursor_new_DB = self.settings.POSTGRES_CURSOR_CONNECTION_STRING_NEW_DB if host is None else self.settings.POSTGRES_CURSOR_CONNECTION_STRING_DOCKER_NEW_DB
